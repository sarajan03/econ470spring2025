...
for year in range(1998, 2012):
    ...
    alpha_path = f"/Users/sushmitarajan/econ470spring2025/Homework2/submission1/data/input/HCRIS_v1996/HospitalFY{year}/hosp_{year}_ALPHA.CSV"
    numeric_path = f"/Users/sushmitarajan/econ470spring2025/Homework2/submission1/data/input/HCRIS_v1996/HospitalFY{year}/hosp_{year}_NMRC.CSV"
    report_path = f"/Users/sushmitarajan/econ470spring2025/Homework2/submission1/data/input/HCRIS_v1996/HospitalFY{year}/hosp_{year}_RPT.CSV"
...
# Save final dataset
final_hcris_v1996.to_csv('/Users/sushmitarajan/econ470spring2025/Homework2/submission1/data/output/HCRIS_v1996.csv', index=False)


final_hcris_v1996.describe()