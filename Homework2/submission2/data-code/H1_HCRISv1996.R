...
########################################################################################
for (i in 1998:2011) {
  HCRIS.alpha=read_csv(paste0("/Users/sushmitarajan/econ470spring2025/Homework2/submission2/data/input/HCRIS_v1996/HospitalFY",i,"/hosp_",i,"_ALPHA.CSV"),
                       col_names=c('RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'))
  HCRIS.numeric=read_csv(paste0("/Users/sushmitarajan/econ470spring2025/Homework2/submission2/data/input/HCRIS_v1996/HospitalFY",i,"/hosp_",i,"_NMRC.CSV"),
                         col_names=c('RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'))
  HCRIS.report=read_csv(paste0("/Users/sushmitarajan/econ470spring2025/Homework2/submission2/data/input/HCRIS_v1996/HospitalFY",i,"/hosp_",i,"_RPT.CSV",sep=""),
...
write_rds(final.hcris.v1996,'/Users/sushmitarajan/econ470spring2025/Homework2/submission2/data/output/HCRIS_Data_v1996.rds')
