...
for year in range(2010, 2018):
    ...
    # Load data
    hcris_alpha = pd.read_csv(f"/Users/sushmitarajan/econ470spring2025/Homework2/submission1/data/input/HCRIS_v2010/HospitalFY{year}/hosp10_{year}_ALPHA.CSV", 
                              names=['RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'], dtype=str)
    hcris_numeric = pd.read_csv(f"/Users/sushmitarajan/econ470spring2025/Homework2/submission1/data/input/HCRIS_v2010/HospitalFY{year}/hosp10_{year}_NMRC.CSV", 
                                names=['RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'], dtype=str)
    hcris_report = pd.read_csv(f"/Users/sushmitarajan/econ470spring2025/Homework2/submission1/data/input/HCRIS_v2010/HospitalFY{year}/hosp10_{year}_RPT.CSV", 
    ...
    # Select relevant report columns
...
final_hcris_v2010.to_csv("/Users/sushmitarajan/econ470spring2025/Homework2/submission2/data/output/HCRIS_v2010.csv", index=False)

final_hcris_v2010.describe()