...
for (y in 2010:2015) {
  ...
  for (m in monthlist) {
    ...
    ma.path=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/monthly-ma-contract-service-area/MA_Cnty_SA_",y,"_",m,".csv")
...
write_rds(contract.service.area,"/Users/sushmitarajan/econ470spring2025/Homework4/data/output/contract_service_area.rds")