...
## 2010
ma.path.2010a=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/cms-payment-data/2010/2010PartCPlanLevel2.xlsx")
...
ma.path.2010b=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/cms-payment-data/2010/2010PartDPlans2.xlsx")
...
## 2011
ma.path.2011a=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/cms-payment-data/2011/2011PartCPlanLevel.xlsx")
risk.rebate.2011a=read_xlsx(ma.path.2011a,range="A4:H2663",
                            col_names=c("contractid","planid","contract_name","plan_type",
                                        "riskscore_partc","payment_partc","rebate_partc",
                                        "msa_deposit_partc"))

ma.path.2011b=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/cms-payment-data/2011/2011PartDPlans.xlsx")
...
## 2012
ma.path.2012a=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/cms-payment-data/2012/2012PartCPlanLevel.xlsx")
risk.rebate.2012a=read_xlsx(ma.path.2012a,range="A4:H2757",
                            col_names=c("contractid","planid","contract_name","plan_type",
                                        "riskscore_partc","payment_partc","rebate_partc",
                                        "msa_deposit_partc"))

ma.path.2012b=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/cms-payment-data/2012/2012PartDPlans.xlsx")
...
## 2013
ma.path.2013a=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/cms-payment-data/2013/2013PartCPlan Level.xlsx")
risk.rebate.2013a=read_xlsx(ma.path.2013a,range="A4:G2968",
                            col_names=c("contractid","planid","contract_name","plan_type",
                                        "riskscore_partc","payment_partc","rebate_partc"))

ma.path.2013b=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/cms-payment-data/2013/2013PartDPlans.xlsx")
...
## 2014
ma.path.2014a=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/cms-payment-data/2014/2014PartCPlan Level.xlsx")
risk.rebate.2014a=read_xlsx(ma.path.2014a,range="A4:G2828",
                            col_names=c("contractid","planid","contract_name","plan_type",
                                        "riskscore_partc","payment_partc","rebate_partc"))

ma.path.2014b=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/cms-payment-data/2014/2014PartDPlans.xlsx")
...
## 2015
ma.path.2015a=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/cms-payment-data/2015/2015PartCPlanLevel.xlsx")
risk.rebate.2015a=read_xlsx(ma.path.2015a,range="A4:G2745",
                            col_names=c("contractid","planid","contract_name","plan_type",
                                        "riskscore_partc","payment_partc","rebate_partc"))

ma.path.2015b=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/cms-payment-data/2015/2015PartDPlans.xlsx")
