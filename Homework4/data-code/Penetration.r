...
for (y in 2010:2015) {
  ...
  for (m in monthlist) {
    ...
    ma.path=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/monthly-ma-state-and-county-penetration/State_County_Penetration_MA_",y,"_",m,".csv")
...
write_rds(ma.penetration.data,"/Users/sushmitarajan/econ470spring2025/Homework4/data/output/ma_penetration.rds")