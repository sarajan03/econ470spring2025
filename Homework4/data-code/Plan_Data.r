...
for (y in 2010:2015) {
  ...
  ma.path=paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/input/monthly-ma-and-pdp-enrollment-by-cpsc/CPSC_Contract_Info_",y,"_01.csv")
...
## Enrollments per plan
  ...
  write_rds(plan.year,paste0("/Users/sushmitarajan/econ470spring2025/Homework4/data/output/ma_data_",y,".rds"))
}
